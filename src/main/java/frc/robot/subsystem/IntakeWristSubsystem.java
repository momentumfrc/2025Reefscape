...
public class IntakeWristSubsystem extends SubsystemBase {
    ...
    public IntakeWristSubsystem() {
        ...
        wristConfig.accept(config -> config.smartCurrentLimit(
                        (int) Prefs.intakeWristSmartCurrentLimit.get().in(Units.Amps))
                .idleMode(IdleMode.kCoast));
        Prefs.intakeWristSmartCurrentLimit.subscribe(
    ...
    public void wristOut() {
        wrist.setVoltage(Prefs.intakeWristPower.get().in(Units.Volts));
    }
    ...
    public void holdWristOut() {
        wrist.setVoltage(Prefs.intakeWristHoldPower.get().in(Units.Volts));
    }
    ...
    public void softHoldWristForAlgaeIntake() {
        wrist.setVoltage(Prefs.intakeWristSoftHoldForIntakePower.get().in(Units.Volts));
    }
